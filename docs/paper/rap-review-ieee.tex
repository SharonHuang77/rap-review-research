...
\begin{figure*}[t]
  \centering
  % === PLACEHOLDER: insert the architecture-ladder diagram here ===
  % Upload the figure to Overleaf as architecture-ladder.png (or .pdf) and
  % ensure it shows all FOUR arms: Agentless, Generalists-3, Hierarchical,
  % Consensus (the earlier three-panel diagram must be extended with the
  % uncoordinated Generalists-3 rung).
  \includegraphics[width=\textwidth]{architecture-ladder.png}
