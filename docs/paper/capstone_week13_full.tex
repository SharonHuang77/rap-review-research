...
$|\delta|{\le}0.06$). A registered Sonnet~4.5 robustness arm, completed at
confirmatory scale on the same 99 Qodo PRs, confirms the ordering is not a Haiku
artifact: Agentless keeps its F1 dominance (0.546 vs.\ 0.388--0.425, Holm
