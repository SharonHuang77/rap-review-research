...
stronger model (Agentless $0.487{\to}0.547$) and the headline ordering---the
single-pass baseline above every multi-agent arm---is unchanged. The ranking
\emph{within} the multi-agent arms is not stable, however: Consensus and
Hierarchical swap under Sonnet (0.428 vs.\ 0.423, against 0.369 vs.\ 0.378 under
Haiku), so we claim model-robustness for the registered conclusions and the
headline ordering, not for the ordering among the multi-agent arms.
