...
\begin{figure*}[t]
  \centering
  % TODO: fig1_architectures.png currently shows THREE panels; extend it with the
  % Generalists-3 rung before submission.
  \includegraphics[width=\textwidth]{fig1_architectures.png}
  \caption{The four-rung communication-topology ladder: Agentless (single pass,
  no communication), Generalists-3 (three uncoordinated samples), Hierarchical
  (coordinator-mediated, one-to-many), and Consensus (peer discussion,
  many-to-many). Solid arrows are control/task flow; dashed arrows are peer
  communication.}
