...
stark (Fig.~\ref{fig:support}a): one confirmed finding costs 0.34 LLM calls under
Agentless and 1.76 under Consensus, a $5\times$ premium for a lower-F1 review. The operational ladder
...
they explain the headline result---extra agents add cost and surface findings in
exactly the class where models disagree.}
\label{fig:support}
\end{figure*}
